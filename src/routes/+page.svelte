...
<div class="h-[calc(100vh-120px)] lg:h-full overflow-none flex flex-col lg:flex-row lg:justify-between">
	{#if mounted}
    ...
    <div class="scrollbar py-4 w-full lg:h-[calc(100vh-120px)] lg:overflow-y-scroll border-2 border-zinc-900 dark:border-zinc-50">
      <div>
